...
```mermaid
flowchart TD
    subgraph Clients [" Clients & Multi-Platform "]
        Web["Web Application / PWA"]
        Mobile["Mobile & Desktop Clients"]
        EdgeNodes["Edge Devices & Terminals"]
    end
    ...
    subgraph CoreEngine [" Application & Domain Core "]
        APIGateway["API & Application Layer"]
        DomainServices["Domain Services & Business Logic"]
        AsyncWorkers["Queue & Background Workers"]
    end
